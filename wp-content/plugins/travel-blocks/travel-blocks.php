...
add_action('acf/init', function () {
    ...
    $acf_blocks = [
        ...
        new \Travel\Blocks\Blocks\ACF\FAQAccordionTwo(), // FAQ Accordion 2 columnas con contador
        ...
        new \Travel\Blocks\Blocks\ACF\DatesAndPricesManual(), // Dates and Prices (Manual ACF)
