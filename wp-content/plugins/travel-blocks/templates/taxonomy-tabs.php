...
<?php
// DEBUG: Show tab overrides data
if (defined('WP_DEBUG') && WP_DEBUG) {
    echo "\n<!-- DEBUG TAB OVERRIDES DATA:\n";
    echo "=== TAB OVERRIDES FROM REPEATER ===\n";
    if (!empty($data['tab_overrides'])) {
        foreach ($data['tab_overrides'] as $idx => $override) {
            echo "Row $idx:\n";
            echo "  term_id: " . ($override['term_id'] ?? 'NOT SET') . "\n";
            echo "  custom_name: " . ($override['custom_name'] ?? 'NOT SET') . "\n";
            echo "  icon: " . (empty($override['icon']) ? 'NO ICON' : 'HAS ICON') . "\n";
        }
    } else {
        echo "NO TAB OVERRIDES CONFIGURED\n";
    }
    ...
    foreach ($tabs as $idx => $tab) {
        ...
        echo "  name: {$tab['name']}\n";
        echo "  slug: {$tab['slug']}\n";
        echo "  icon: " . (empty($tab['icon']) ? 'NO ICON' : 'HAS ICON') . "\n";
        echo "  cards_count: " . count($tab['cards']) . "\n";
    }
    echo "-->\n";
}
