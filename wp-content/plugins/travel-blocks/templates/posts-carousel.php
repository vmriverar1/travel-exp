                ...
                <a href="<?php echo esc_url($link); ?>" class="pc-card__link">
                    <div class="pc-card__content">
                        ...
                        <?php if ($card_style !== 'overlay-split'): ?>
                            <!-- Divider Line (between title and excerpt for overlay variant) -->
                            <?php if ($title && $excerpt): ?>
                                <div class="pc-card__divider"></div>
                            <?php endif; ?>
                        <?php endif; ?>

                        <?php if ($card_style === 'overlay' && $excerpt): ?>
                            <!-- OVERLAY: Excerpt con botón inline a la derecha (última línea) -->
                        ...
                        <?php else: ?>
                            ...
                            <!-- CTA Button (solo para vertical, overlay usa inline-cta) -->
