...
/**
 * Template: Top
 * Layout: Cards on top, hero text at bottom with hero background
 */
...
$class_to_add = 'hc-hero-carousel hc-hero-carousel--top text-align-' . esc_attr($text_alignment) . ' button-align-' . esc_attr($button_alignment);
...
$wrapper_attrs .= ' data-variation="top"'; // Help React identify this as a different component
foreach ($carousel_attrs as $key => $value) {
    $wrapper_attrs .= ' ' . esc_attr($key) . '="' . esc_attr($value) . '"';
}
?>

<div <?php echo $wrapper_attrs; ?> key="hero-carousel-top">
    ...
    <div class="hc-content <?php echo $has_hero_text ? 'hc-content--with-text' : 'hc-content--centered'; ?>">
        ...
        <!-- Hero Text at Bottom (InnerBlocks) -->
