...
class RelatedPackages
{
    ...
    public function register_acf_fields(): void
    {
        ...
        acf_add_local_field_group([
            ...
            'fields' => [
                ...
                [
                    'key' => 'field_rp_description_lines',
                    'label' => '📝 Líneas de Descripción',
                    'name' => 'description_lines',
                    'type' => 'number',
                    'instructions' => 'Número de líneas a mostrar en la descripción (por defecto 3).',
                    'default_value' => 3,
                    'min' => 1,
                    'max' => 10,
                    'step' => 1,
                ...
                // ========================================
                [
                    'key' => 'field_rp_tab_desktop',
                    'label' => '🖥️ Desktop',
                    'type' => 'tab',
                ],
                [
                    'key' => 'field_rp_desktop_message',
                    'label' => '',
                    'type' => 'message',
                    'message' => '<strong>Configuración para pantallas grandes (≥769px)</strong>',
                ],
                [
                    ...
                    'type' => 'number',
                    'instructions' => 'Altura de las cards en desktop (px)',
                    'default_value' => 350,
                    'min' => 200,
                    'max' => 800,
                    'step' => 10,
                ...
                [
                    ...
                    'label' => '↔️ Espacio entre Cards',
                    'name' => 'card_gap',
                    'type' => 'range',
                    'instructions' => 'Espacio entre cards en pixels',
                    'default_value' => 24,
                    'min' => 8,
                    'max' => 64,
                    'step' => 4,
                ...
                [
                    ...
                    'name' => 'hover_effect',
                    'type' => 'select',
                    'instructions' => 'Efecto al pasar el mouse sobre una card',
                    'choices' => [
                        'lift' => 'Lift (Elevar con sombra)',
                        'scale' => 'Scale (Zoom)',
                        'none' => 'Ninguno',
                    ],
                    'default_value' => 'lift',
                ...
                // ========================================
                [
                    'key' => 'field_rp_tab_mobile',
                    'label' => '📱 Mobile',
                    'type' => 'tab',
                ],
                [
                    'key' => 'field_rp_mobile_message',
                    'label' => '',
                    'type' => 'message',
                    'message' => '<strong>Configuración para pantallas pequeñas (≤768px)</strong><br>En mobile se convierte en slider horizontal.',
                ],
                [
                    'key' => 'field_rp_mobile_card_height',
                    'label' => '📏 Altura de Cards Mobile',
                    'name' => 'mobile_card_height',
                    'type' => 'number',
                    'instructions' => 'Altura de las cards en mobile (px)',
                    'default_value' => 280,
                    'min' => 150,
                    'max' => 500,
                    'step' => 10,
                ...
                [
                    'key' => 'field_rp_mobile_card_width',
                    'label' => '📐 Ancho de Cards Mobile (%)',
                    'name' => 'mobile_card_width',
                    'type' => 'range',
                    'instructions' => 'Porcentaje del ancho de pantalla que ocupa cada card',
                    'default_value' => 85,
                    'min' => 70,
                    'max' => 100,
                    'step' => 5,
    ...
    public function render($block, $content = '', $is_preview = false, $post_id = 0): void
    {
        try {
            ...
            $acf_description_lines = get_field('description_lines') ?: 3;
            ...
            // Mobile settings
            $acf_mobile_card_height = get_field('mobile_card_height') ?: 280;
            $acf_mobile_card_width = get_field('mobile_card_width') ?: 85;
            ...
            // If no fields selected, use sensible defaults
            if (empty($display_fields)) {
                $display_fields = ['image', 'category', 'title', 'description', 'duration', 'price'];
            }
            ...
            $data = [
                ...
                'description_lines' => $acf_description_lines,
                ...
                'mobile_card_height' => $acf_mobile_card_height,
                'mobile_card_width' => $acf_mobile_card_width,
